import { Box, Button, ButtonSpinner, Center, Container, Heading } from '@chakra-ui/react';
...
const Body = () => {
  ...
  return (
    <Container height={'100vh'}>
      <Box mt={100} display='flex' justifyContent='center' alignItems='center' flexDirection='column'  >
        ...
        <br />
        <Button backgroundColor={'blackAlpha.300'} _hover='none' size="md" fontWeight="semibold" color='white' onClick={toggleMode} m={1}>{mode}</Button>  <br />
        <Box m={0} p={0}>
